export type RadarFilterState = {
  ...
  minLegitimacy: string; minSourceConfidence: string; saved: string; entered: string; sourceType: string; sort: string; page: string;
};
export const defaultRadarFilters: RadarFilterState = { q: "", category: "", minPrize: "", deadlineBefore: "", startAfter: "", frequency: "", maxEffort: "", country: "", region: "", age: "", sponsor: "", purchaseRequired: "", socialRequired: "", minLegitimacy: "", minSourceConfidence: "", saved: "", entered: "", sourceType: "", sort: "recommended", page: "1" };
